          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">Cadastre seu restaurante!</h1>
              </div>
              <form class="user">
                <div class="form-group row">
                  <div class="col-sm-12 col-md-5 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="document" placeholder="CNPJ">
                  </div>
                  <div class="col-sm-12 col-md-7">
                    <input type="text" class="form-control form-control-user" id="company_name" placeholder="Nome do restaurante">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-sm-12 col-md-5 mb-3 mb-sm-0">
                ...
                <button class="btn btn-primary btn-user btn-block" id="btn_register_restaurant">
                  Cadastrar
                </button>
              </form>
              <hr>
